...
/**
 * Action to fold all doc: blocks in the current file.
 */
class FoldDocBlocksAction : AnAction() {
    ...
    /**
     * Fold all blocks of the specified type (reusing logic from FoldTestBlocksAction).
     */
